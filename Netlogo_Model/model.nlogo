...
cameras-own [fov dis]
securities-own [last-target last-objective objective objective-start-tick objective-number at-platform moving seen-list has-baggage aesthetic carrying-baggage gait actioning judgement vulnerability aesthetic suspicious-level stopped money victim-target] ; features that security can be given
...
criminals-own [last-target last-objective objective objective-start-tick objective-number money wants-to-exit visible seen aesthetic seen-list has-baggage carrying-baggage gait victim-target judgement vulnerability suspicious-level stopped] ; features that criminals can be given
baggages-own [owner]
...
@#$#@#$#@
<experiments>
  <experiment name="experiment" repetitions="3000" runMetricsEveryStep="true">
    <setup>set-up</setup>
    <go>go</go>
    <exitCondition>end-state or ticks &gt; 2000</exitCondition>
    <metric>current-patch-type-criminal</metric>
    <metric>current-x-cor-criminal</metric>
    <metric>current-y-cor-criminal</metric>
    <metric>current-platform-criminal</metric>
    <metric>memory-criminal</metric>
    <metric>criminal-cash</metric>
    <metric>no-of-robberies-criminal</metric>
    <metric>last-objective-criminal</metric>
    <metric>last-target-criminal</metric>
    <metric>objective-criminal</metric>
    <metric>target-criminal</metric>
    <metric>current-patch-type-security</metric>
    <metric>current-x-cor-security</metric>
    <metric>current-y-cor-security</metric>
    <metric>current-platform-security</metric>
    <metric>memory-security</metric>
    <metric>number-so-far-questioned-security</metric>
    <metric>last-objective-security</metric>
    <metric>last-target-security</metric>
    <metric>objective-security</metric>
    <metric>target-security</metric>
    <enumeratedValueSet variable="average-arrival-number">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ticks-per-arrival">
      <value value="80"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max_passengers_on_carriages_when_created">
      <value value="5"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
